...
public class LandlineDecoderSriLanka extends LandlineDecoderAbstract {

    boolean areaCodePopulated = false;
    HashMap<String, String> mpAreaCodeRegion = new HashMap<String, String>(30);

    @Override
    public String getUserCountryTreePath() {
        return "Earth/Asia/Sri Lanka";
    }

    private void populateAreaCodes() {

        readFile( "RegionsAndLandline_Asia_SriLanka.txt");
        String line = null;
    ...
    private void processLine(String line) {
        ...
        countryCode = ShieldConstants.COUNTRY_CODE_SRI_LANKA+countryCode;
    ...
    public void getCallerInfo(RequestObject ro){
        ...
        //default
        ro.setStrTreepathCallerLocation("Asia/Sri Lanka");
        ro.setStrCallerAreaCode(ShieldConstants.COUNTRY_CODE_SRI_LANKA);
        ...
        //requestObject.setCCC(ShieldConstants.COUNTRY_CODE_SRI_LANKA+"");
        if (phoneNumber.startsWith("0")) {
            phoneNumber = phoneNumber.replaceFirst("0", ShieldConstants.COUNTRY_CODE_SRI_LANKA+"");
        }
        else if (phoneNumber.startsWith("+"+ShieldConstants.COUNTRY_CODE_SRI_LANKA)) {
