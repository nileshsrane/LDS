...
public class LandlineDecoderBhutan extends LandlineDecoderAbstract {

    boolean areaCodePopulated = false;
    HashMap<String, String> mpAreaCodeRegion = new HashMap<String, String>(25);

    @Override
    public String getUserCountryTreePath() {
        return "Earth/Asia/Bhutan";
    }

    private void populateAreaCodes() {
        readFile( "RegionsAndLandline_Asia_Bhutan.txt");
        String line = null;
    ...
    private void processLine(String line) {
        ...
        countryCode = ShieldConstants.COUNTRY_CODE_BHUTAN+countryCode;
    ...
    public void getCallerInfo(RequestObject ro){
        ...
        //default
        ro.setStrTreepathCallerLocation("Asia/Bhutan");
        ro.setStrCallerAreaCode(ShieldConstants.COUNTRY_CODE_BHUTAN);
        ...
        //requestObject.setCCC(ShieldConstants.COUNTRY_CODE_BHUTAN+"");
        if (phoneNumber.startsWith("0")) {
            phoneNumber = phoneNumber.replaceFirst("0", ShieldConstants.COUNTRY_CODE_BHUTAN+"");
        }
        else if (phoneNumber.startsWith("+"+ShieldConstants.COUNTRY_CODE_BHUTAN)) {
