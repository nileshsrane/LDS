...
public class LandlineDecoderFrance extends LandlineDecoderAbstract {
    ...
    public String getUserCountryTreePath() {
        return "Earth/Europe/France";
    }


    private void populateAreaCodes() {
        readFile( "RegionsAndLandline_Europe_Russia.txt");
        String line = null;
    ...
    private void processLine(String line) {
        ...
        countryCode = ShieldConstants.COUNTRY_CODE_RUSSIA + countryCode;
    ...
    public void getCallerInfo(RequestObject requestObject) {
        ...
        readFile( "RegionsAndLandline_Europe_FraRussia.txt");

        //default should be India region
        requestObject.setStrTreepathCallerLocation("Europe/Russia");
        requestObject.setStrCallerAreaCode(ShieldConstants.COUNTRY_CODE_RUSSIA);

        String phoneNumber = requestObject.getStrCallerPhoneNumber();

        //requestObject.setCCC(ShieldConstants.COUNTRY_CODE_UK + "");
        if (phoneNumber.startsWith("0")) {
            phoneNumber = phoneNumber.replaceFirst("0", ShieldConstants.COUNTRY_CODE_RUSSIA + "");
        } else if (phoneNumber.startsWith("+" + ShieldConstants.COUNTRY_CODE_RUSSIA)) {
